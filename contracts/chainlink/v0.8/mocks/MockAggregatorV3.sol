...
contract MockAggregatorV3 is Setter, AggregatorV3Interface {
    ...
    function getRoundData(uint80 _roundId) public view returns (uint80 roundId_, int256 answer_, uint256 startedAt_, uint256 updatedAt_, uint80 answeredInRound_) {
