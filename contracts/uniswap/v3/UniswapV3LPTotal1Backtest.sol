...
/// @title Uniswap V3 Liquidity Provider Token1 Total Backtester
/// @notice Backtests an LP position in pool reporting total token1 value (fees + principal) of LP tokens
contract UniswapV3LPTotal1Backtest is UniswapV3LPBacktest {
    constructor(address _manager) UniswapV3LPBacktest(_manager) {}

    /// @notice Reports the total token1 value of the LP tokens owned by this contract
    /// @return value_ The current token1 value of the LP tokens owned by this contract
