...
/// @title Uniswap V3 Liquidity Provider Token0 Fee Backtester
/// @notice Backtests an LP position in pool reporting accumulated fees token0 value of LP tokens
contract UniswapV3LPFee0Backtest is UniswapV3LPBacktest {
    constructor(address _manager) UniswapV3LPBacktest(_manager) {}

    /// @notice Reports the accumulated fee token0 value of the LP tokens owned by this contract
    /// @return value_ The current token0 accumulated fees of the LP tokens owned by this contract
